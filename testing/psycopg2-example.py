...
try:
  ...
  cur = conn.cursor()
  cur.execute("CREATE DATABASE tcount1;")
  cur.close()
  conn.close()
except:
  print("Could not create tcount1")

#Connecting to tcount

conn = psycopg2.connect(database="tcount1", user="postgres", password="pass", host="localhost", port="5432")
...
#Insert
cur.execute("INSERT INTO tweetwordcount (word,count) VALUES ('candy', 1);");
conn.commit()
